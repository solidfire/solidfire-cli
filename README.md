...
If you are on a mac, you will have to set up a virtual environment first because the native mac python does not support setuptools. To create a virtualenvironment, run
    ...
    source pythoncli/bin/activate # This activates the virtual environment. To get back to it later, reactivate it.

Next, irrespective of your OS there are two ways in which you can install the tool:
