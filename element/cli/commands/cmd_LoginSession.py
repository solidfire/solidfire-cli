...
@pass_context
def cli(ctx):
    """SetRemoteLoggingHosts GetInfo GetRemoteLoggingHosts SetInfo """
...
def SetRemoteLoggingHosts(ctx,
    ...
    try:
        _SetRemoteLoggingHostsResult = ctx.element.set_remote_logging_hosts(remote_hosts=remote_hosts)
