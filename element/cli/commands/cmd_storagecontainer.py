...
@cli.command('modify', short_help="""Modifies an existing storage container. """)
...
@cli.command('create', short_help="""Creates a new VVols storage container. """)
@click.option('--name',
              type=str,
              required=True,
...
@cli.command('getefficiency', short_help="""GetStorageContainerEfficiency enables you to retrieve efficiency information about a virtual volume storage container. """)
@click.option('--storagecontainerid',
              type=str,
              required=True,
