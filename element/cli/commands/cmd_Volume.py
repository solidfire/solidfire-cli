...
@pass_context
def cli(ctx):
    """ListActive ListForAccount Copy PurgeDeleted RestoreDeleted ListStatsByAccessGroup Clone UpdateBulkStatus GetCount Create StartBulkWrite GetEfficiency CancelGroupClone GetStats ListStatsBy GetAsyncResult ListStatsByAccount CancelClone StartBulkRead Delete SetDefaultQoS CloneMultiple ListDeleted List GetDefaultQoS ListAsyncResults ListBulkJobs Modify """
...
def ListActive(ctx,
    ...
    try:
        _ListActiveVolumesResult = ctx.element.list_active_volumes(start_volume_id=start_volume_id, limit=limit)
...
def ListForAccount(ctx,
    ...
    try:
        _ListVolumesForAccountResult = ctx.element.list_volumes_for_account(account_id=account_id, start_volume_id=start_volume_id, limit=limit)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def Copy(ctx,
    ...
    try:
        _CopyVolumeResult = ctx.element.copy_volume(volume_id=volume_id, dst_volume_id=dst_volume_id, snapshot_id=snapshot_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def PurgeDeleted(ctx,
    ...
    try:
        _PurgeDeletedVolumeResult = ctx.element.purge_deleted_volume(volume_id=volume_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def RestoreDeleted(ctx,
    ...
    ctx.logger.info("""volume_id = """+str(volume_id)+""";"""+"")
    try:
        _RestoreDeletedVolumeResult = ctx.element.restore_deleted_volume(volume_id=volume_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def ListStatsByAccessGroup(ctx,
    ...
    try:
        _ListVolumeStatsByVolumeAccessGroupResult = ctx.element.list_volume_stats_by_volume_access_group(volume_access_groups=volume_access_groups)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def Clone(ctx,
    ...
    try:
        _CloneVolumeResult = ctx.element.clone_volume(volume_id=volume_id, name=name, new_account_id=new_account_id, new_size=new_size, access=access, snapshot_id=snapshot_id, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def UpdateBulkStatus(ctx,
    ...
    try:
        _UpdateBulkVolumeStatusResult = ctx.element.update_bulk_volume_status(key=key, status=status, percent_complete=percent_complete, message=message, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def Create(ctx,
    ...
    try:
        _CreateVolumeResult = ctx.element.create_volume(name=name, account_id=account_id, total_size=total_size, enable512e=enable512e, qos=qos, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def StartBulkWrite(ctx,
    ...
    try:
        _StartBulkVolumeWriteResult = ctx.element.start_bulk_volume_write(volume_id=volume_id, format=format, script=script, script_parameters=script_parameters, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def GetEfficiency(ctx,
    ...
    ctx.logger.info("""volume_id = """+str(volume_id)+""";"""+"")
    try:
        _GetVolumeEfficiencyResult = ctx.element.get_volume_efficiency(volume_id=volume_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def CancelGroupClone(ctx,
    ...
    try:
        _CancelGroupCloneResult = ctx.element.cancel_group_clone(group_clone_id=group_clone_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def GetStats(ctx,
    ...
    ctx.logger.info("""volume_id = """+str(volume_id)+""";"""+"")
    try:
        _GetVolumeStatsResult = ctx.element.get_volume_stats(volume_id=volume_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def GetAsyncResult(ctx,
    ...
    try:
        _GetAsyncResultResult = ctx.element.get_async_result(async_handle=async_handle)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def CancelClone(ctx,
    ...
    try:
        _CancelCloneResult = ctx.element.cancel_clone(clone_id=clone_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def StartBulkRead(ctx,
    ...
    try:
        _StartBulkVolumeReadResult = ctx.element.start_bulk_volume_read(volume_id=volume_id, format=format, snapshot_id=snapshot_id, script=script, script_parameters=script_parameters, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def Delete(ctx,
    ...
    ctx.logger.info("""volume_id = """+str(volume_id)+""";"""+"")
    try:
        _DeleteVolumeResult = ctx.element.delete_volume(volume_id=volume_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def SetDefaultQoS(ctx,
    ...
    try:
        _SetDefaultQoSResult = ctx.element.set_default_qos(min_iops=min_iops, max_iops=max_iops, burst_iops=burst_iops)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def CloneMultiple(ctx,
    ...
    try:
        _CloneMultipleVolumesResult = ctx.element.clone_multiple_volumes(volumes=volumes, access=access, group_snapshot_id=group_snapshot_id, new_account_id=new_account_id)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def List(ctx,
    ...
    try:
        _ListVolumesResult = ctx.element.list_volumes(start_volume_id=start_volume_id, limit=limit, volume_status=volume_status, accounts=accounts, is_paired=is_paired, volume_ids=volume_ids)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def ListAsyncResults(ctx,
    ...
    try:
        _ListAsyncResultsResult = ctx.element.list_async_results(async_result_types=async_result_types)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def Modify(ctx,
    ...
    try:
        _ModifyVolumeResult = ctx.element.modify_volume(volume_id=volume_id, account_id=account_id, access=access, qos=qos, total_size=total_size, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
