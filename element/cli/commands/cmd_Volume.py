...
=======
    """ListActive CloneMultiple StartBulkRead ListForAccount CancelClone StartBulkWrite GetStats ListBulkJobs Modify GetEfficiency Copy ListStatsBy ListDeleted Create PurgeDeleted RestoreDeleted ListStatsByAccount GetCount SetDefaultQoS ListStatsByAccessGroup ListAsyncResults List UpdateBulkStatus GetDefaultQoS GetAsyncResult Delete CancelGroupClone Clone """
...
def ListActive(ctx,
    ...
    cli_utils.print_result(ListActiveVolumesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def CloneMultiple(ctx,
    ...
    cli_utils.print_result(CloneMultipleVolumesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def StartBulkRead(ctx,
    ...
    cli_utils.print_result(StartBulkVolumeReadResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListForAccount(ctx,
    ...
    cli_utils.print_result(ListVolumesForAccountResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def CancelClone(ctx,
    ...
    cli_utils.print_result(CancelCloneResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def StartBulkWrite(ctx,
    ...
    cli_utils.print_result(StartBulkVolumeWriteResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetStats(ctx,
    ...
    cli_utils.print_result(GetVolumeStatsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListBulkJobs(ctx):
    ...
    cli_utils.print_result(ListBulkVolumeJobsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListForAccount(ctx,
    ...
    """ListVolumesForAccount returns the list of active AND (pending) deleted volumes for an account."""
=======
    cli_utils.print_result(ModifyVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(GetVolumeEfficiencyResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
def Copy(ctx,
    ...
    cli_utils.print_result(CopyVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(ListVolumeStatsByVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListDeleted(ctx):
    ...
    cli_utils.print_result(ListDeletedVolumesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(CreateVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
def PurgeDeleted(ctx,
    ...
    cli_utils.print_result(PurgeDeletedVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(RestoreDeletedVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
def StartBulkWrite(ctx,
    ...
    """Communications and server interaction information for external data access is passed by a script running on the SolidFire storage system."""
=======
    cli_utils.print_result(ListVolumeStatsByAccountResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def StartBulkRead(ctx,
    ...
    """Snapshots are not created when cluster fullness is at stage 4 or 5."""
=======
    cli_utils.print_result(GetVolumeCountResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Copy(ctx,
    ...
    """Copies one volume to another."""
=======
    cli_utils.print_result(SetDefaultQoSResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Create(ctx,
    ...
    """When the volume is created successfully it is available for connection via iSCSI."""
=======
    cli_utils.print_result(ListVolumeStatsByVolumeAccessGroupResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(ListAsyncResultsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
=======
    cli_utils.print_result(ListVolumesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
def UpdateBulkStatus(ctx,
    ...
    cli_utils.print_result(UpdateBulkVolumeStatusResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(VolumeQOS, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(GetAsyncResultResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
def ListAsyncResults(ctx,
    ...
    """You can use ListAsyncResults to list the results of all currently running and completed asynchronous methods on the system. Querying asynchronous results with ListAsyncResults does not cause completed asyncHandles to expire; you can use GetAsyncResult to query any of the asyncHandles returned by ListAsyncResults."""
=======
    cli_utils.print_result(DeleteVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(CancelGroupCloneResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
=======
    cli_utils.print_result(CloneVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
