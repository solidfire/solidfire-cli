...
@pass_context
def cli(ctx):
    """Modify GetEfficiency ListDeleted GetStats CancelGroupClone ListBulkJobs ListAsyncResults GetCount Copy SetDefaultQoS PurgeDeleted CloneMultiple ListStatsByAccount GetDefaultQoS ListForAccount GetAsyncResult StartBulkWrite RestoreDeleted UpdateBulkStatus Delete StartBulkRead ListStatsByAccessGroup ListStatsBy Clone CancelClone Create ListActive List """
