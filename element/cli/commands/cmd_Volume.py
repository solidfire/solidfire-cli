...
@pass_context
def cli(ctx):
    """Clone RestoreDeleted Copy GetEfficiency ListStatsByAccount StartBulkRead GetAsyncResult StartBulkWrite GetStats ListStatsByAccessGroup ListForAccount Modify Delete GetDefaultQoS GetCount ListDeleted CancelGroupClone UpdateBulkStatus CancelClone CloneMultiple List PurgeDeleted ListStatsBy Create ListActive SetDefaultQoS ListAsyncResults ListBulkJobs """
