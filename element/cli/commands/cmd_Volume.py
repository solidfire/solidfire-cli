...
@pass_context
def cli(ctx):
    """Modify GetStats UpdateBulkStatus Clone ListActive ListForAccount GetAsyncResult GetDefaultQoS Create CancelGroupClone ListStatsBy CloneMultiple GetEfficiency CancelClone ListAsyncResults ListBulkJobs RestoreDeleted GetCount StartBulkWrite ListStatsByAccount List ListDeleted Delete Copy SetDefaultQoS ListStatsByAccessGroup StartBulkRead PurgeDeleted """
