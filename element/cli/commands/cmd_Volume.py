...
@pass_context
def cli(ctx):
    """ListStatsBy List Delete ListForAccount GetStats GetCount ListDeleted Modify Copy PurgeDeleted CancelClone ListStatsByAccessGroup ListStatsByAccount RestoreDeleted GetAsyncResult ListAsyncResults ListBulkJobs SetDefaultQoS Create CancelGroupClone Clone StartBulkRead GetEfficiency StartBulkWrite UpdateBulkStatus GetDefaultQoS ListActive CloneMultiple """
