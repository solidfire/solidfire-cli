...
@pass_context
def cli(ctx):
    """getorigin setnetworkconfig listall getnetworkconfig listpending listactive getpendingoperation listpendingactive setconfig remove getbootstrapconfig liststats getstats add getconfig """
