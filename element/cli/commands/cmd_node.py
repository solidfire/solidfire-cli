...
@pass_context
def cli(ctx):
    """setconfig listall setnetworkconfig remove getorigin listactive getconfig getnetworkconfig getbootstrapconfig liststats listpendingactive getstats getpendingoperation add listpending """
