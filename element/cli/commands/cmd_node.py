...
@pass_context
def cli(ctx):
    """remove getpendingoperation getbootstrapconfig getnetworkconfig setnetworkconfig setconfig listpendingactive add getstats listactive listpending getorigin liststats listall getconfig """
