...
@pass_context
def cli(ctx):
    """listactive liststats add getbootstrapconfig listpending getnetworkconfig setnetworkconfig listall getorigin listpendingactive setconfig getpendingoperation getconfig remove getstats """
