...
@pass_context
def cli(ctx):
    """getstats getpendingoperation listall liststats getorigin remove setnetworkconfig add listpending listactive getbootstrapconfig getnetworkconfig listpendingactive setconfig getconfig """
