...
@pass_context
def cli(ctx):
    """setnetworkconfig getpendingoperation liststats listpendingactive getconfig listpending remove add getnetworkconfig listactive getstats getorigin setconfig getbootstrapconfig listall """
