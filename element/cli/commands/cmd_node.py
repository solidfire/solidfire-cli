...
@pass_context
def cli(ctx):
    """listpending getnetworkconfig remove setconfig listpendingactive getorigin listactive add getstats getconfig liststats getbootstrapconfig setnetworkconfig listall getpendingoperation """
