...
@pass_context
def cli(ctx):
    """listall getconfig listactive setconfig add getstats getorigin getbootstrapconfig setnetworkconfig remove getnetworkconfig liststats listpendingactive listpending getpendingoperation """
