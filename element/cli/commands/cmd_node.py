...
@pass_context
def cli(ctx):
    """listpendingactive remove listpending listactive getstats add listall setconfig getconfig getorigin setnetworkconfig getpendingoperation liststats getbootstrapconfig getnetworkconfig """
