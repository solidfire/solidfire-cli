...
@pass_context
def cli(ctx):
    """remove add listactive listpending setconfig liststats listall setnetworkconfig getbootstrapconfig getnetworkconfig getconfig getorigin getstats listpendingactive getpendingoperation """
