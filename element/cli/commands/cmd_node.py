...
@pass_context
def cli(ctx):
    """listpendingactive listactive setnetworkconfig listall getorigin liststats getpendingoperation setconfig getbootstrapconfig listpending getnetworkconfig getconfig getstats remove add """
