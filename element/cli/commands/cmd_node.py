...
@pass_context
def cli(ctx):
    """setconfig getpendingoperation setnetworkconfig add getorigin listpendingactive getstats listpending getnetworkconfig remove getconfig listactive liststats listall getbootstrapconfig """
