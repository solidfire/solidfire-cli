...
@pass_context
def cli(ctx):
    """listall getorigin listactive listpendingactive setconfig remove listpending setnetworkconfig getconfig getbootstrapconfig getpendingoperation getstats liststats getnetworkconfig add """
