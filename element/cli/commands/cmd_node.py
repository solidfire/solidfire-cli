...
@pass_context
def cli(ctx):
    """getnetworkconfig listactive liststats add getstats setconfig listall listpendingactive getconfig getbootstrapconfig getorigin remove setnetworkconfig getpendingoperation listpending """
