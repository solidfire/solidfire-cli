...
@pass_context
def cli(ctx):
    """setnetworkconfig liststats getconfig remove getnetworkconfig getstats getbootstrapconfig listpendingactive setconfig add getorigin listall getpendingoperation listactive listpending """
