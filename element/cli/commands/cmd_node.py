...
@pass_context
def cli(ctx):
    """listpending listpendingactive setconfig getstats getpendingoperation getorigin listall add listactive getconfig remove getbootstrapconfig setnetworkconfig getnetworkconfig liststats """
