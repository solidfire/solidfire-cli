...
@pass_context
def cli(ctx):
    """getbootstrapconfig liststats getorigin getstats remove listall add listpendingactive setconfig getpendingoperation setnetworkconfig getnetworkconfig listactive getconfig listpending """
