...
@pass_context
def cli(ctx):
    """listall add getnetworkconfig getbootstrapconfig setnetworkconfig getconfig listpendingactive getorigin liststats remove getpendingoperation setconfig getstats listpending listactive """
