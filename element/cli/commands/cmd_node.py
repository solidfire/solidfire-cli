...
@pass_context
def cli(ctx):
    """getorigin remove getpendingoperation setnetworkconfig getconfig listactive getstats getnetworkconfig listall listpending add setconfig getbootstrapconfig listpendingactive liststats """
