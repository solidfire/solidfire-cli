...
@pass_context
def cli(ctx):
    """getpendingoperation listall getconfig getnetworkconfig setnetworkconfig listactive setconfig getbootstrapconfig getstats liststats listpending getorigin listpendingactive remove add """
