...
@pass_context
def cli(ctx):
    """setconfig listpending add getbootstrapconfig getpendingoperation listpendingactive listall getnetworkconfig getstats remove listactive getorigin setnetworkconfig getconfig liststats """
