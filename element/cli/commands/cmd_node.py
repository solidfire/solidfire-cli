...
@pass_context
def cli(ctx):
    """listactive add getstats listpendingactive getorigin setconfig listpending setnetworkconfig getnetworkconfig getpendingoperation remove listall liststats getbootstrapconfig getconfig """
