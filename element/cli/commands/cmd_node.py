...
@pass_context
def cli(ctx):
    """add listactive liststats remove setnetworkconfig getconfig setconfig getstats listall getbootstrapconfig listpendingactive getpendingoperation getnetworkconfig listpending getorigin """
