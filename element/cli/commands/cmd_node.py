...
@pass_context
def cli(ctx):
    """listpendingactive setconfig getconfig setnetworkconfig getbootstrapconfig remove listall listactive liststats getpendingoperation getorigin getnetworkconfig getstats add listpending """
