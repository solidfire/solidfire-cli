...
@pass_context
def cli(ctx):
    """setnetworkconfig add listactive getpendingoperation getconfig listpending getstats listpendingactive getnetworkconfig remove getorigin getbootstrapconfig listall liststats setconfig """
