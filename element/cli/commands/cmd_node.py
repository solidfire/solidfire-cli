...
@pass_context
def cli(ctx):
    """getconfig add remove listpending listall setnetworkconfig setconfig listpendingactive getbootstrapconfig getpendingoperation getorigin listactive liststats getnetworkconfig getstats """
