...
@pass_context
def cli(ctx):
    """resyncsnapmirrorrelationship modifysnapmirrorrelationship createsnapmirrorendpointunmanaged breaksnapmirrorvolume createsnapmirrorvolume listchedules getsnapmirrorclusteridentity modifysnapmirrorendpoint listsnapmirrorendpoints createsnapmirrorendpoint listsnapmirrorvservers quiescesnapmirrorrelationship deletesnapmirrorendpoints listsnapmirrorpolicies listsnapmirrornetworkinterfaces listsnapmirrorluns listsnapmirroraggregates resumesnapmirrorrelationship listsnapmirrornodes modifysnapmirrorendpointunmanaged listsnapmirrorvolumes abortsnapmirrorrelationship createsnapmirrorrelationship deletesnapmirrorrelationships getontapversioninfo listsnapmirrorrelationships updatesnapmirrorrelationship breaksnapmirrorrelationship initializesnapmirrorrelationship """

@cli.command('resyncsnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the ResyncSnapMirrorRelationship method to establish or reestablish a mirror relationship between a source and destination endpoint. When you resync a relationship, the system removes snapshots on the destination volume that are newer than the common snapshot copy, and then mounts the destination volume as a data protection volume with the common snapshot copy as the exported snapshot copy. """, cls=SolidFireCommand)
...
@click.option('--namesourcevolume',
              ...
              help="""The name of the volume. """)
@pass_context
def resyncsnapmirrorrelationship(ctx,
...
@cli.command('modifysnapmirrorrelationship', short_help="""You can use ModifySnapMirrorRelationship to change the intervals at which a scheduled snapshot occurs. You can also delete or pause a schedule by using this method. """, cls=SolidFireCommand)
...
@click.option('--snapmirrorendpointid',
              ...
              help="""The endpoint ID of the remote ONTAP storage system communicating with the SolidFire cluster. """)
@pass_context
def modifysnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@pass_context
def createsnapmirrorendpointunmanaged(ctx,
           # Mandatory main parameter
           clustername,
           # Mandatory main parameter
           ipaddresses):
...
@cli.command('createsnapmirrorvolume', short_help="""The SolidFire Element OS web UI uses the CreateSnapMirrorVolume method to create a volume on the remote ONTAP system. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@pass_context
def createsnapmirrorvolume(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory main parameter
           vserver,
...
@cli.command('listchedules', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorSchedules method to get a list of schedules that are available on a remote ONTAP cluster. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@cli.command('getsnapmirrorclusteridentity', short_help="""The SolidFire Element OS web UI uses GetSnapMirrorClusterIdentity to get identity information about the ONTAP cluster. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def getsnapmirrorclusteridentity(ctx,
           # Optional main parameter
           snapmirrorendpointid = None):
...
@cli.command('modifysnapmirrorendpoint', short_help="""The SolidFire Element OS web UI uses the ModifySnapMirrorEndpoint method to change the name and management attributes for a SnapMirror endpoint. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@pass_context
def modifysnapmirrorendpoint(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Optional main parameter
           managementip = None,
...
@cli.command('listsnapmirrorendpoints', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorEndpoints method to list all SnapMirror endpoints that the SolidFire cluster is communicating with. """, cls=SolidFireCommand)
...
@pass_context
def listsnapmirrorendpoints(ctx,
           # Optional main parameter
...
@cli.command('createsnapmirrorendpoint', short_help="""The SolidFire Element OS web UI uses the CreateSnapMirrorEndpoint method to create a relationship with a remote SnapMirror endpoint. """, cls=SolidFireCommand)
@click.option('--managementip',
              type=str,
              required=True,
              prompt=True,
...
@pass_context
def createsnapmirrorendpoint(ctx,
           # Mandatory main parameter
           managementip,
           # Mandatory main parameter
           username,
...
@cli.command('listsnapmirrorvservers', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorVservers method to list all SnapMirror Vservers available on a remote ONTAP system. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def listsnapmirrorvservers(ctx,
           # Optional main parameter
           snapmirrorendpointid = None,
           # Optional main parameter
           vservertype = None,
...
@cli.command('quiescesnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the QuiesceSnapMirrorRelationship method to disable future data transfers for a SnapMirror relationship. If a transfer is in progress, the relationship status becomes "quiescing" until the transfer is complete. If the current transfer is aborted, it will not restart. You can reenable data transfers for the relationship using the ResumeSnapMirrorRelationship API method. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--name',
              ...
              help="""The name of the volume. """)
@pass_context
def quiescesnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@cli.command('deletesnapmirrorendpoints', short_help="""The SolidFire Element OS web UI uses DeleteSnapMirrorEndpoints to delete one or more SnapMirror endpoints from the system. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointids',
              type=str,
              required=True,
              prompt=True,
...
@pass_context
def deletesnapmirrorendpoints(ctx,
           # Mandatory main parameter
...
@cli.command('listsnapmirrorpolicies', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorPolicies method to list all SnapMirror policies on a remote ONTAP system. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def listsnapmirrorpolicies(ctx,
           # Optional main parameter
           snapmirrorendpointid = None):
...
@cli.command('listsnapmirrornetworkinterfaces', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorNetworkInterfaces method to list all available SnapMirror interfaces on a remote ONTAP system """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def listsnapmirrornetworkinterfaces(ctx,
           # Optional main parameter
           snapmirrorendpointid = None,
           # Optional main parameter
           interfacerole = None):
...
@cli.command('listsnapmirrorluns', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorLuns method to list the LUN information for the SnapMirror relationship from the remote ONTAP cluster. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@cli.command('listsnapmirroraggregates', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorAggregates method to list all SnapMirror aggregates that are available on the remote ONTAP system. An aggregate describes a set of physical storage resources. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def listsnapmirroraggregates(ctx,
           # Optional main parameter
           snapmirrorendpointid = None):
...
@cli.command('resumesnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the ResumeSnapMirrorRelationship method to enable future transfers for a quiesced SnapMirror relationship. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--name',
              ...
              help="""The name of the volume. """)
@pass_context
def resumesnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@cli.command('listsnapmirrornodes', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorNodes method to get a list of nodes in a remote ONTAP cluster. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@cli.command('modifysnapmirrorendpointunmanaged', short_help="""The SolidFire Element OS web UI uses the ModifySnapMirrorEndpoint method to change the name and management attributes for a SnapMirror endpoint. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@pass_context
def modifysnapmirrorendpointunmanaged(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Optional main parameter
           clustername = None,
...
@cli.command('listsnapmirrorvolumes', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorVolumes method to list all SnapMirror volumes available on a remote ONTAP system. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@cli.command('abortsnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the AbortSnapMirrorRelationship method to stop SnapMirror transfers that have started but are not yet complete. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@pass_context
def abortsnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@cli.command('createsnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the CreateSnapMirrorRelationship method to create a SnapMirror extended data protection relationship between a source and destination endpoint. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--maxtransferrate',
              ...
              help="""Specifies the maximum data transfer rate between the volumes in kilobytes per second. The default value, 0, is unlimited and permits the SnapMirror relationship to fully utilize the available network bandwidth. """)
@pass_context
def createsnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           typesourcevolume,
...
@cli.command('deletesnapmirrorrelationships', short_help="""The SolidFire Element OS web UI uses the DeleteSnapMirrorRelationships method to remove a SnapMirror relationship between a source and destination endpoint. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--name',
              ...
              help="""The name of the volume. """)
@pass_context
def deletesnapmirrorrelationships(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@cli.command('listsnapmirrorrelationships', short_help="""The SolidFire Element OS web UI uses the ListSnapMirrorRelationships method to list one or all SnapMirror relationships on a SolidFire cluster """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=False,
...
@pass_context
def listsnapmirrorrelationships(ctx,
           # Optional main parameter
           snapmirrorendpointid = None,
           # Optional subparameter of optional main parameter.
...
@cli.command('updatesnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the UpdateSnapMirrorRelationship method to make the destination volume in a SnapMirror relationship an up-to-date mirror of the source volume. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--maxtransferrate',
              ...
              help="""Specifies the maximum data transfer rate between the volumes in kilobytes per second. The default value, 0, is unlimited and permits the SnapMirror relationship to fully utilize the available network bandwidth. """)
@pass_context
def updatesnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@click.option('--name',
              ...
              help="""The name of the volume. """)
@pass_context
def breaksnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
...
@cli.command('initializesnapmirrorrelationship', short_help="""The SolidFire Element OS web UI uses the InitializeSnapMirrorRelationship method to initialize the destination volume in a SnapMirror relationship by performing an initial baseline transfer between clusters. """, cls=SolidFireCommand)
@click.option('--snapmirrorendpointid',
              type=int,
              required=True,
              prompt=True,
...
@click.option('--maxtransferrate',
              ...
              help="""Specifies the maximum data transfer rate between the volumes in kilobytes per second. The default value, 0, is unlimited and permits the SnapMirror relationship to fully utilize the available network bandwidth. """)
@pass_context
def initializesnapmirrorrelationship(ctx,
           # Mandatory main parameter
           snapmirrorendpointid,
           # Mandatory subparameter of a mandatory main parameter (Not fully decomposed)
           type,
