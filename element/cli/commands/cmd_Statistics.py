...
=======
    """GetHardwareInfo ListVolumeStats GetCompleteStats GetRawStats ListDriveStats ListVolumeStatsByVirtualVolume """
...
def GetHardwareInfo(ctx):
    ...
    cli_utils.print_result(GetHardwareInfoResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListVolumeStats(ctx,
    ...
    cli_utils.print_result(ListVolumeStatsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetCompleteStats(ctx):
    ...
    cli_utils.print_result(str, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
=======
    cli_utils.print_result(ListDriveStatsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
...
=======
    cli_utils.print_result(ListVolumeStatsByVirtualVolumeResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
>>>>>>> Adds non-pickle json functionality so that set-networkconfig can use get-networkconfig's output.
