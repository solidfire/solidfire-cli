...
@pass_context
def cli(ctx):
    """ListGroup DeleteGroup ModifySchedule CreateGroup ListSchedules ModifyGroup Modify List RollbackToGroup Create Delete GetSchedule RollbackTo CreateSchedule """
...
def ListGroup(ctx,
    ...
    cli_utils.print_result(ListGroupSnapshotsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def DeleteGroup(ctx,
    ...
    cli_utils.print_result(DeleteGroupSnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ModifySchedule(ctx,
    ...
    cli_utils.print_result(ModifyScheduleResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def CreateGroup(ctx,
    ...
    cli_utils.print_result(CreateGroupSnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListSchedules(ctx):
    ...
    cli_utils.print_result(ListSchedulesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ModifyGroup(ctx,
    ...
    cli_utils.print_result(ModifyGroupSnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Modify(ctx,
    ...
    cli_utils.print_result(ModifySnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def List(ctx,
    ...
    cli_utils.print_result(ListSnapshotsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Create(ctx,
    ...
    cli_utils.print_result(CreateSnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Delete(ctx,
    ...
    cli_utils.print_result(DeleteSnapshotResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetSchedule(ctx,
    ...
    cli_utils.print_result(GetScheduleResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def CreateSchedule(ctx,
    ...
    cli_utils.print_result(CreateScheduleResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
