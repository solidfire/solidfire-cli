...
@pass_context
def cli(ctx):
    """Delete CreateGroup ListSchedules RollbackTo ModifyGroup GetSchedule Modify ModifySchedule DeleteGroup List Create RollbackToGroup CreateSchedule ListGroup """
