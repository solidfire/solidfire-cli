...
@pass_context
def cli(ctx):
    """List DeleteGroup GetSchedule Create ModifyGroup Delete CreateSchedule Modify ModifySchedule ListGroup ListSchedules RollbackToGroup RollbackTo CreateGroup """
