...
@pass_context
def cli(ctx):
    """modify deletegroup listgroup modifygroup create list modifyschedule delete creategroup createschedule rollbacktogroup rollbackto listschedules getschedule """
