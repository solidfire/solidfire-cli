...
@pass_context
def cli(ctx):
    """list modifygroup rollbackto modifyschedule delete creategroup modify listschedules listgroup createschedule deletegroup getschedule create rollbacktogroup """
