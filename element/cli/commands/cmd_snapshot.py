...
@pass_context
def cli(ctx):
    """rollbackto rollbacktogroup create getschedule delete listschedules modifygroup modifyschedule deletegroup creategroup modify createschedule listgroup list """
