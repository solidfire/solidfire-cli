...
@pass_context
def cli(ctx):
    """listschedules createschedule listgroup getschedule delete list rollbackto create deletegroup rollbacktogroup modifygroup modifyschedule modify creategroup """
