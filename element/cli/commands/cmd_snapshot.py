...
@pass_context
def cli(ctx):
    """getschedule create rollbacktogroup createschedule deletegroup rollbackto creategroup modifyschedule delete modifygroup listgroup modify list listschedules """
