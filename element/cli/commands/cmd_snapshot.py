...
@pass_context
def cli(ctx):
    """createschedule delete create modifyschedule listgroup deletegroup creategroup modify modifygroup listschedules getschedule rollbackto list rollbacktogroup """
