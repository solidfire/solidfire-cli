...
@pass_context
def cli(ctx):
    """listgroup getschedule createschedule listschedules deletegroup create rollbacktogroup delete creategroup rollbackto modify list modifygroup modifyschedule """
