...
@pass_context
def cli(ctx):
    """getschedule listschedules modifyschedule delete modify modifygroup list rollbacktogroup listgroup create creategroup rollbackto deletegroup createschedule """
