...
@pass_context
def cli(ctx):
    """create modify creategroup modifygroup list rollbacktogroup modifyschedule getschedule listgroup delete listschedules createschedule rollbackto deletegroup """
