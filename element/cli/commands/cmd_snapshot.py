...
@pass_context
def cli(ctx):
    """modify create rollbacktogroup delete list creategroup modifyschedule deletegroup modifygroup createschedule listgroup rollbackto listschedules getschedule """
