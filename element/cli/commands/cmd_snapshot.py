...
@pass_context
def cli(ctx):
    """modifygroup listschedules list delete deletegroup modify getschedule creategroup create rollbackto rollbacktogroup createschedule modifyschedule listgroup """
