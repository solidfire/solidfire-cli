...
@pass_context
def cli(ctx):
    """create modifyschedule creategroup deletegroup list modifygroup delete createschedule listgroup listschedules rollbackto getschedule modify rollbacktogroup """
