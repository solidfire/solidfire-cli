...
@pass_context
def cli(ctx):
    """modify rollbackto getschedule createschedule rollbacktogroup listgroup delete modifyschedule modifygroup deletegroup listschedules creategroup create list """
