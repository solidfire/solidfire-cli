...
@pass_context
def cli(ctx):
    """modifygroup deletegroup getschedule modify creategroup delete listgroup modifyschedule create list rollbackto createschedule rollbacktogroup listschedules """
