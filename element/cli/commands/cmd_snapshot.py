...
@pass_context
def cli(ctx):
    """deletegroup creategroup modify rollbackto listgroup modifyschedule list getschedule listschedules modifygroup rollbacktogroup createschedule create delete """
