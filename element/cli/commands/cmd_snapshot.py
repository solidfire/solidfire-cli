...
@pass_context
def cli(ctx):
    """getschedule deletegroup rollbackto modifyschedule list modifygroup create listgroup creategroup delete modify listschedules rollbacktogroup createschedule """
