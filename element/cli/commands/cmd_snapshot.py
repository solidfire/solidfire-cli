...
@pass_context
def cli(ctx):
    """rollbackto deletegroup delete listgroup create modifygroup rollbacktogroup list creategroup modifyschedule listschedules getschedule modify createschedule """
