...
@pass_context
def cli(ctx):
    """creategroup getschedule rollbacktogroup modify modifygroup delete listgroup list modifyschedule rollbackto create deletegroup createschedule listschedules """
