...
@pass_context
def cli(ctx):
    """creategroup create listgroup createschedule listschedules getschedule modifyschedule delete deletegroup modifygroup list modify rollbacktogroup rollbackto """
