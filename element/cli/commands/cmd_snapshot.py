...
@pass_context
def cli(ctx):
    """modifyschedule delete listgroup modifygroup rollbackto createschedule creategroup deletegroup getschedule list rollbacktogroup listschedules create modify """
