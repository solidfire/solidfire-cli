...
@pass_context
def cli(ctx):
    """deletegroup rollbacktogroup listschedules createschedule delete create list getschedule rollbackto creategroup modify modifyschedule listgroup modifygroup """
...
def create(ctx,
    ...
    try:
        _CreateSnapshotResult = ctx.element.create_snapshot(volume_id=volumeid, snapshotid=snapshotid, name=name, enableremotereplication=enableremotereplication, retention=retention, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def list(ctx,
    ...
    try:
        _ListSnapshotsResult = ctx.element.list_snapshots(volumeid=volumeid)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def creategroup(ctx,
    ...
    try:
        _CreateGroupSnapshotResult = ctx.element.create_group_snapshot(volumes=volumes, name=name, enableremotereplication=enableremotereplication, retention=retention, attributes=attributes)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def modify(ctx,
    ...
    try:
        _ModifySnapshotResult = ctx.element.modify_snapshot(snapshot_id=snapshotid, expirationtime=expirationtime, enableremotereplication=enableremotereplication)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def listgroup(ctx,
    ...
    ctx.logger.info("""volumeid = """+str(volumeid)+""";"""+"")
    try:
        _ListGroupSnapshotsResult = ctx.element.list_group_snapshots(volumeid=volumeid)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
...
def modifygroup(ctx,
    ...
    try:
        _ModifyGroupSnapshotResult = ctx.element.modify_group_snapshot(group_snapshot_id=groupsnapshotid, expirationtime=expirationtime, enableremotereplication=enableremotereplication)
    except common.ApiServerError as e:
        ctx.logger.error(e.message)
        exit()
    except BaseException as e:
