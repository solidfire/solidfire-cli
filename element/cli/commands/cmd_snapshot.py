...
@pass_context
def cli(ctx):
    """modify listgroup delete creategroup deletegroup list getschedule createschedule listschedules create modifygroup rollbackto rollbacktogroup modifyschedule """
