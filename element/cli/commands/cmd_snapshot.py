...
@pass_context
def cli(ctx):
    """rollbacktogroup creategroup delete modifyschedule deletegroup create modifygroup list listgroup rollbackto getschedule createschedule listschedules modify """
