...
@pass_context
def cli(ctx):
    """deletegroup listgroup createschedule create creategroup rollbacktogroup listschedules modify delete rollbackto modifyschedule list getschedule modifygroup """
