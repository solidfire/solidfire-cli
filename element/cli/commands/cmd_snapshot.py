...
@pass_context
def cli(ctx):
    """deletegroup modify creategroup listschedules rollbackto rollbacktogroup modifyschedule getschedule createschedule listgroup delete list create modifygroup """
