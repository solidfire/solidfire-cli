...
@pass_context
def cli(ctx):
    """listgroup modifygroup list create modify createschedule deletegroup getschedule rollbacktogroup rollbackto creategroup modifyschedule listschedules delete """
