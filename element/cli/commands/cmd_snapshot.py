...
@pass_context
def cli(ctx):
    """modify modifygroup listgroup listschedules delete rollbackto getschedule list modifyschedule deletegroup createschedule rollbacktogroup creategroup create """
