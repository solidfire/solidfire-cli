...
@pass_context
def cli(ctx):
    """GetConfig Remove ListAll GetBootstrapConfig GetStats GetPendingOperation ListActive ListStats ListPendingActive ListPending GetNetworkConfig GetOrigin Add SetConfig SetNetworkConfig """
...
def GetConfig(ctx):
    ...
    cli_utils.print_result(GetConfigResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Remove(ctx,
    ...
    cli_utils.print_result(RemoveNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListAll(ctx):
    ...
    cli_utils.print_result(ListAllNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetBootstrapConfig(ctx):
    ...
    cli_utils.print_result(GetBootstrapConfigResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetStats(ctx,
    ...
    cli_utils.print_result(GetNodeStatsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetPendingOperation(ctx):
    ...
    cli_utils.print_result(GetPendingOperationResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListActive(ctx):
    ...
    cli_utils.print_result(ListActiveNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListStats(ctx):
    ...
    cli_utils.print_result(ListNodeStatsResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListPendingActive(ctx):
    ...
    cli_utils.print_result(ListPendingActiveNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def ListPending(ctx):
    ...
    cli_utils.print_result(ListPendingNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetNetworkConfig(ctx):
    ...
    cli_utils.print_result(GetNetworkConfigResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def GetOrigin(ctx,
    ...
    cli_utils.print_result(GetOriginResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def Add(ctx,
    ...
    cli_utils.print_result(AddNodesResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def SetConfig(ctx,
    ...
    cli_utils.print_result(SetConfigResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
...
def SetNetworkConfig(ctx,
    ...
    cli_utils.print_result(SetNetworkConfigResult, ctx.logger, as_json=ctx.json, as_pickle=ctx.pickle, depth=ctx.depth, filter_tree=ctx.filter_tree)
