...
@pass_context
def cli(ctx):
    """GetBootstrapConfig GetStats ListPending ListPendingActive Remove Add GetPendingOperation GetConfig ListAll SetNetworkConfig ListActive SetConfig GetNetworkConfig GetOrigin ListStats """
