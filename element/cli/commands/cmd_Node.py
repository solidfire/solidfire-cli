...
@pass_context
def cli(ctx):
    """GetConfig ListPendingActive Add GetStats GetNetworkConfig ListStats GetOrigin SetConfig GetBootstrapConfig ListPending ListAll Remove ListActive SetNetworkConfig GetPendingOperation """
