...
@pass_context
def cli(ctx):
    """GetConfig ListAll GetPendingOperation GetBootstrapConfig SetConfig Add GetNetworkConfig SetNetworkConfig ListPending ListActive ListStats GetStats ListPendingActive Remove GetOrigin """
