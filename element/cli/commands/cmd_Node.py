...
@pass_context
def cli(ctx):
    """ListPendingActive Add GetConfig GetBootstrapConfig GetStats GetPendingOperation ListPending SetConfig SetNetworkConfig Remove GetNetworkConfig ListStats GetOrigin ListAll ListActive """
