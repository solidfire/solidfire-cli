...
@pass_context
def cli(ctx):
    """restoredeleted liststatsbyaccessgroup clone listdeleted getstats setdefaultqos startbulkwrite getdefaultqos liststatsby create liststatsbyaccount modify listactive cancelgroupclone updatebulkstatus clonemultiple list purgedeleted getefficiency startbulkread listbulkjobs delete listforaccount cancelclone copy getcount """
