...
@pass_context
def cli(ctx):
    """cancelclone setdefaultqos liststatsbyaccount getcount getasyncresult copy purgedeleted listactive liststatsbyaccessgroup getdefaultqos listforaccount clonemultiple modify clone liststatsby listasyncresults listbulkjobs create updatebulkstatus startbulkwrite restoredeleted getstats list startbulkread delete listdeleted cancelgroupclone getefficiency """
