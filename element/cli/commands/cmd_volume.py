...
@pass_context
def cli(ctx):
    """listdeleted liststatsby create startbulkread getefficiency liststatsbyaccessgroup listactive liststatsbyaccount list cancelclone liststats getstats purgedeleted getdefaultqos delete updatebulkstatus removefromaccessgroup copy listbulkjobs addtoaccessgroup startbulkwrite modify getcount cancelgroupclone setdefaultqos listforaccount clonemultiple clone restoredeleted """
