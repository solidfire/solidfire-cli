...
@pass_context
def cli(ctx):
    """modify getasyncresult cancelclone getcount getefficiency cancelgroupclone setdefaultqos listdeleted create restoredeleted getstats listasyncresults updatebulkstatus startbulkread liststatsbyaccount list liststatsby listbulkjobs clonemultiple listforaccount clone startbulkwrite delete liststatsbyaccessgroup getdefaultqos listactive purgedeleted copy """
