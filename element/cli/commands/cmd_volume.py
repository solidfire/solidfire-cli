...
@pass_context
def cli(ctx):
    """listasyncresults listforaccount purgedeleted restoredeleted liststatsbyaccount list updatebulkstatus copy getstats liststatsby getcount setdefaultqos listactive startbulkread getefficiency getasyncresult startbulkwrite cancelclone listbulkjobs clone listdeleted delete create clonemultiple modify cancelgroupclone liststatsbyaccessgroup getdefaultqos """
