...
@pass_context
def cli(ctx):
    """clonemultiple restoredeleted purgedeleted getdefaultqos updatebulkstatus modify liststatsbyaccount delete listdeleted startbulkwrite setdefaultqos getstats listasyncresults copy liststatsby listactive cancelgroupclone clone getasyncresult getefficiency listbulkjobs startbulkread create list listforaccount liststatsbyaccessgroup cancelclone getcount """
