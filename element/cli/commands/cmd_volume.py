...
@pass_context
def cli(ctx):
    """cancelclone getefficiency liststatsbyaccount listasyncresults getasyncresult modify cancelgroupclone liststatsbyaccessgroup delete listforaccount listactive getcount list startbulkread restoredeleted setdefaultqos getstats copy create clone startbulkwrite listdeleted getdefaultqos liststatsby clonemultiple purgedeleted updatebulkstatus listbulkjobs """
