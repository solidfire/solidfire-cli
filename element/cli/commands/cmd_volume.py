...
@pass_context
def cli(ctx):
    """list restoredeleted copy listactive listdeleted setdefaultqos liststatsby cancelclone liststatsbyaccount getasyncresult delete purgedeleted getcount listbulkjobs listforaccount clonemultiple liststatsbyaccessgroup listasyncresults getefficiency startbulkwrite getstats getdefaultqos clone startbulkread modify updatebulkstatus create cancelgroupclone """
