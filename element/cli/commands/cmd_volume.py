...
@pass_context
def cli(ctx):
    """getdefaultqos cancelclone getstats startbulkread getefficiency liststatsby listdeleted getasyncresult liststatsbyaccount listbulkjobs liststatsbyaccessgroup updatebulkstatus create listasyncresults clone list listactive clonemultiple getcount delete cancelgroupclone restoredeleted listforaccount purgedeleted copy startbulkwrite modify setdefaultqos """
