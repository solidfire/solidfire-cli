...
@pass_context
def cli(ctx):
    """getstats listactive getasyncresult startbulkwrite liststatsby listbulkjobs getdefaultqos restoredeleted listasyncresults listforaccount list liststatsbyaccount delete getefficiency clonemultiple modify updatebulkstatus setdefaultqos cancelclone create startbulkread clone copy getcount liststatsbyaccessgroup purgedeleted cancelgroupclone listdeleted """
