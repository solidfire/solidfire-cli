...
@pass_context
def cli(ctx):
    """restoredeleted listdeleted getasyncresult listforaccount clone liststatsby liststatsbyaccessgroup updatebulkstatus clonemultiple startbulkread liststatsbyaccount list delete copy modify cancelgroupclone cancelclone getefficiency listactive getstats create listasyncresults purgedeleted getcount setdefaultqos startbulkwrite listbulkjobs getdefaultqos """
