...
@pass_context
def cli(ctx):
    """listdeleted listforaccount create startbulkread modify getefficiency startbulkwrite liststatsbyaccessgroup listasyncresults setdefaultqos list listbulkjobs copy getdefaultqos liststatsby getcount liststatsbyaccount purgedeleted getstats clonemultiple clone cancelclone delete updatebulkstatus cancelgroupclone listactive getasyncresult restoredeleted """
