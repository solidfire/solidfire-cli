...
@pass_context
def cli(ctx):
    """restoredeleted delete cancelclone getefficiency liststatsby listbulkjobs listasyncresults create getasyncresult updatebulkstatus listforaccount getdefaultqos getcount getstats startbulkwrite cancelgroupclone purgedeleted clonemultiple setdefaultqos clone startbulkread list copy listdeleted liststatsbyaccessgroup listactive modify liststatsbyaccount """
