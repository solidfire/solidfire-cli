...
@pass_context
def cli(ctx):
    """copy cancelclone liststatsbyaccessgroup create liststatsbyaccount listdeleted delete getasyncresult cancelgroupclone getdefaultqos listasyncresults listbulkjobs list liststatsby updatebulkstatus startbulkwrite getefficiency listactive clone getcount clonemultiple restoredeleted modify purgedeleted startbulkread getstats setdefaultqos listforaccount """
