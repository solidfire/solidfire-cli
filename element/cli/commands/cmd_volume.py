...
@pass_context
def cli(ctx):
    """modify updatebulkstatus cancelclone getstats copy purgedeleted create listactive cancelgroupclone startbulkwrite listforaccount listbulkjobs delete restoredeleted liststatsbyaccount getefficiency startbulkread liststatsbyaccessgroup liststatsby getdefaultqos clone list getcount setdefaultqos listasyncresults clonemultiple listdeleted getasyncresult """
