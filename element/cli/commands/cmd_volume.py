...
@pass_context
def cli(ctx):
    """liststatsbyaccessgroup startbulkread startbulkwrite create getefficiency copy listbulkjobs getstats updatebulkstatus liststatsbyaccount getasyncresult getcount cancelclone listasyncresults list clone cancelgroupclone liststatsby setdefaultqos listactive restoredeleted clonemultiple getdefaultqos delete listforaccount modify purgedeleted listdeleted """
