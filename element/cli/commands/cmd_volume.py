...
@pass_context
def cli(ctx):
    """modify liststatsbyaccessgroup listforaccount getcount create list startbulkread liststatsbyaccount cancelgroupclone clonemultiple cancelclone setdefaultqos copy listactive listasyncresults listbulkjobs liststatsby restoredeleted getstats clone startbulkwrite getdefaultqos listdeleted getefficiency updatebulkstatus getasyncresult purgedeleted delete """
