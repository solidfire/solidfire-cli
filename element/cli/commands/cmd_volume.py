...
@pass_context
def cli(ctx):
    """listdeleted updatebulkstatus listforaccount liststatsby copy clonemultiple liststatsbyaccessgroup setdefaultqos getcount startbulkwrite cancelclone restoredeleted liststatsbyaccount getstats listactive startbulkread listbulkjobs clone getefficiency modify delete list create purgedeleted getdefaultqos cancelgroupclone """
