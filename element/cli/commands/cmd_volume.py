...
@pass_context
def cli(ctx):
    """purgedeleted liststatsbyaccessgroup setdefaultqos getefficiency cancelclone updatebulkstatus liststatsbyaccount listdeleted modify liststatsby listbulkjobs list copy getdefaultqos listforaccount clonemultiple restoredeleted getcount cancelgroupclone listactive startbulkwrite startbulkread getstats clone create delete """
