...
@pass_context
def cli(ctx):
    """listbulkjobs getefficiency startbulkread clonemultiple liststatsbyaccount clone setdefaultqos restoredeleted getasyncresult listasyncresults liststatsbyaccessgroup list listforaccount cancelclone getstats delete liststatsby create purgedeleted copy listdeleted startbulkwrite cancelgroupclone getdefaultqos modify getcount updatebulkstatus listactive """
