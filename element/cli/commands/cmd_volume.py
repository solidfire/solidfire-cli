...
@pass_context
def cli(ctx):
    """getstats listdeleted create listbulkjobs startbulkread purgedeleted delete addtoaccessgroup list removefromaccessgroup liststatsbyaccessgroup modify liststats clone updatebulkstatus restoredeleted listforaccount cancelclone getdefaultqos liststatsbyaccount copy listactive cancelgroupclone getcount liststatsby getefficiency setdefaultqos startbulkwrite clonemultiple """
