...
@pass_context
def cli(ctx):
    """getefficiency copy purgedeleted delete updatebulkstatus cancelclone list listdeleted create setdefaultqos clone getasyncresult clonemultiple listforaccount getstats getcount listbulkjobs listasyncresults modify listactive startbulkwrite liststatsbyaccount liststatsby startbulkread restoredeleted getdefaultqos cancelgroupclone liststatsbyaccessgroup """
