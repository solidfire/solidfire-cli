...
@pass_context
def cli(ctx):
    """clonemultiple liststatsbyaccessgroup cancelclone listbulkjobs listdeleted getdefaultqos clone startbulkread liststatsbyaccount create liststatsby getstats listforaccount modify restoredeleted copy delete getcount getefficiency list cancelgroupclone listactive getasyncresult setdefaultqos startbulkwrite updatebulkstatus listasyncresults purgedeleted """
