...
@pass_context
def cli(ctx):
    """create gettaskupdate listbindings modifymetadata getvasaproviderinfo listhosts snapshot list listtasks unbindallfromhost modifyhost copydiffsto querymetadata getunsharedchunks unbind getcount canceltask createhost preparevirtualsnapshot fastclone delete clone getunsharedbitmap enablefeature getfeaturestatus modifyvasaproviderinfo bind modify rollback getallocatedbitmap """
