...
@pass_context
def cli(ctx):
    """listbindings list enablefeature create modifymetadata copydiffsto createhost fastclone snapshot modifyhost unbindallfromhost canceltask getcount getallocatedbitmap gettaskupdate rollback listhosts getunsharedbitmap getfeaturestatus preparevirtualsnapshot getvasaproviderinfo getunsharedchunks clone bind delete modifyvasaproviderinfo modify listtasks unbind querymetadata """
