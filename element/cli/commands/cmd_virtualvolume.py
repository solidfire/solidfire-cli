...
@pass_context
def cli(ctx):
    """listtasks modify getcount gettaskupdate enablefeature getfeaturestatus modifymetadata list snapshot unbind unbindallfromhost copydiffsto preparevirtualsnapshot clone create createhost getunsharedchunks modifyvasaproviderinfo canceltask modifyhost listbindings getvasaproviderinfo getallocatedbitmap rollback fastclone bind getunsharedbitmap delete querymetadata listhosts """
