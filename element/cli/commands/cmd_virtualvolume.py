...
@pass_context
def cli(ctx):
    """unbindallfromhost modifymetadata bind create getunsharedchunks gettaskupdate listbindings getvasaproviderinfo snapshot list modifyhost modifyvasaproviderinfo copydiffsto modify rollback canceltask clone getfeaturestatus getcount preparevirtualsnapshot delete fastclone unbind listtasks getunsharedbitmap enablefeature listhosts querymetadata createhost getallocatedbitmap """
