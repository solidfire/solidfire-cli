...
@pass_context
def cli(ctx):
    """ModifyFullThreshold GetStats GetMasterNodeID GetSnmpState SetSnmpInfo GetFullThreshold RemoveAdmin EnableEncryptionAtRest AddAdmin GetCapacity GetLimits ClearFaults ListAdmins ListSyncJobs GetSnmpInfo DisableSnmp DisableEncryptionAtRest SnmpSendTestTraps GetSnmpTrapInfo Create GetNtpInfo SetSnmpACL ListFaults GetAPI GetConfig ModifyAdmin GetState GetCurrentAdmin ListEvents GetSystemStatus DeleteAllSupportBundles GetVersionInfo EnableSnmp GetSnmpACL SetNtpInfo CreateSupportBundle SetSnmpTrapInfo GetInfo SetConfig """
