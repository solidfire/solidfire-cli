...
@pass_context
def cli(ctx):
    """GetConfig SetNtpInfo GetInfo EnableSnmp GetStats GetState SnmpSendTestTraps GetCurrentAdmin GetSnmpACL ListEvents GetSystemStatus GetLimits ListFaults DeleteAllSupportBundles RemoveAdmin DisableEncryptionAtRest ModifyFullThreshold ClearFaults GetNtpInfo SetConfig DisableSnmp ModifyAdmin AddAdmin GetVersionInfo GetAPI GetSnmpInfo SetSnmpACL GetMasterNodeID GetSnmpTrapInfo GetSnmpState Create CreateSupportBundle SetSnmpTrapInfo ListAdmins GetCapacity SetSnmpInfo EnableEncryptionAtRest ListSyncJobs GetFullThreshold """
