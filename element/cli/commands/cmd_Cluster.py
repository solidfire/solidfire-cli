...
@pass_context
def cli(ctx):
    """GetConfig GetSnmpTrapInfo GetCapacity EnableSnmp GetSnmpState GetStats GetCurrentAdmin SetSnmpInfo ListAdmins GetSnmpACL GetAPI SetConfig GetState AddAdmin GetLimits GetInfo DisableSnmp CreateSupportBundle DeleteAllSupportBundles ListSyncJobs GetSystemStatus SetNtpInfo ClearFaults SetSnmpACL ListEvents GetVersionInfo ModifyAdmin SnmpSendTestTraps ListFaults EnableEncryptionAtRest ModifyFullThreshold GetSnmpInfo DisableEncryptionAtRest RemoveAdmin GetNtpInfo GetMasterNodeID Create SetSnmpTrapInfo GetFullThreshold """
