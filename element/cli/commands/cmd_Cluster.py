...
@pass_context
def cli(ctx):
    """ClearFaults GetSystemStatus EnableEncryptionAtRest GetSnmpState GetFullThreshold SetSnmpInfo GetLimits RemoveAdmin GetAPI GetNtpInfo SetNtpInfo GetCapacity ModifyFullThreshold GetSnmpInfo Create EnableSnmp DisableSnmp GetStats GetInfo SetSnmpACL DisableEncryptionAtRest ListFaults GetState GetCurrentAdmin ListSyncJobs ListAdmins CreateSupportBundle GetSnmpTrapInfo SetSnmpTrapInfo GetVersionInfo SnmpSendTestTraps GetConfig AddAdmin DeleteAllSupportBundles GetMasterNodeID SetConfig GetSnmpACL ModifyAdmin ListEvents """
