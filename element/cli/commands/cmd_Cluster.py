...
@pass_context
def cli(ctx):
    """ListFaults CreateSupportBundle SetSnmpACL DisableSnmp ListAdmins GetSnmpInfo GetFullThreshold SetSnmpInfo GetSnmpState GetStats SetConfig SnmpSendTestTraps EnableSnmp GetMasterNodeID GetInfo SetSnmpTrapInfo GetNtpInfo GetCurrentAdmin ClearFaults ListSyncJobs ModifyAdmin GetConfig Create GetSystemStatus GetCapacity ModifyFullThreshold EnableEncryptionAtRest GetAPI GetVersionInfo SetNtpInfo DisableEncryptionAtRest RemoveAdmin GetSnmpTrapInfo DeleteAllSupportBundles GetState GetSnmpACL AddAdmin ListEvents GetLimits """
