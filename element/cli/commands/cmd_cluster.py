...
@pass_context
def cli(ctx):
    """getapi modifyfullthreshold setsnmpacl setsnmptrapinfo disablesnmp disableencryptionatrest listadmins enableencryptionatrest setconfig setsnmpinfo snmpsendtesttraps getstats getsnmptrapinfo getsnmpacl getstate setntpinfo createsupportbundle getntpinfo listsyncjobs enablesnmp listfaults getsnmpinfo create getfullthreshold getmasternodeid getconfig getcapacity clearfaults deleteallsupportbundles modifyadmin removeadmin getsystemstatus getinfo getcurrentadmin getsnmpstate getversioninfo addadmin getlimits listevents """
