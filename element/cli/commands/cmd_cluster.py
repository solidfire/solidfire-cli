...
@pass_context
def cli(ctx):
    """getmasternodeid getsystemstatus getstats setsnmpinfo getsnmpinfo getconfig getinfo getlimits clearfaults getsnmpacl enablesnmp setsnmpacl listadmins addadmin disablesnmp setsnmptrapinfo modifyadmin disableencryptionatrest enableencryptionatrest setconfig modifyfullthreshold removeadmin listevents getapi deleteallsupportbundles snmpsendtesttraps getcurrentadmin getstate createsupportbundle getsnmptrapinfo listfaults getfullthreshold create setntpinfo listsyncjobs getntpinfo getsnmpstate getcapacity getversioninfo """
