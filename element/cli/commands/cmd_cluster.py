...
@pass_context
def cli(ctx):
    """deleteallsupportbundles getconfig createsupportbundle getmasternodeid listsyncjobs listadmins getfullthreshold removeadmin getstate clearfaults modifyfullthreshold getlimits disableencryptionatrest getsystemstatus modifyadmin getcurrentadmin listevents getcapacity setntpinfo addadmin create getapi listfaults enableencryptionatrest getversioninfo getstats getntpinfo getinfo setconfig """
