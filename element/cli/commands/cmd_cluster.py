...
@pass_context
def cli(ctx):
    """listadmins getapi getcapacity getconfig addadmin getsystemstatus createsupportbundle getinfo setntpinfo getstate enableencryptionatrest listevents disableencryptionatrest getcurrentadmin setconfig getfullthreshold modifyfullthreshold getversioninfo modifyadmin getstats clearfaults listfaults removeadmin deleteallsupportbundles listsyncjobs getmasternodeid getntpinfo getlimits create """
