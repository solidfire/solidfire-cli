...
@pass_context
def cli(ctx):
    """setconfig snmpsendtesttraps getsnmpstate addadmin create getmasternodeid setsnmpacl clearfaults getinfo getfullthreshold getcurrentadmin getsystemstatus getcapacity removeadmin getntpinfo modifyadmin listadmins enablesnmp disableencryptionatrest getsnmpinfo modifyfullthreshold getapi getstate listsyncjobs deleteallsupportbundles setsnmptrapinfo getlimits getsnmpacl getconfig enableencryptionatrest getsnmptrapinfo listfaults setsnmpinfo getstats setntpinfo createsupportbundle disablesnmp listevents getversioninfo """
