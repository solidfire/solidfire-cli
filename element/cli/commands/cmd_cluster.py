...
@pass_context
def cli(ctx):
    """getcompletestats create getfullthreshold enableencryptionatrest getinfo setconfig getversioninfo listevents modifyfullthreshold deleteallsupportbundles clearfaults getapi getstate getrawstats getcapacity setntpinfo getntpinfo disableencryptionatrest getmasternodeid listfaults getconfig getsystemstatus listsyncjobs getlimits getstats createsupportbundle """
