...
@pass_context
def cli(ctx):
    """setsnmpacl create getconfig deleteallsupportbundles getsnmptrapinfo getlimits listadmins listevents getntpinfo getstate getsystemstatus modifyadmin listfaults modifyfullthreshold getmasternodeid enablesnmp enableencryptionatrest disablesnmp getversioninfo getinfo setconfig getsnmpacl getfullthreshold setntpinfo disableencryptionatrest addadmin getstats getapi createsupportbundle snmpsendtesttraps getsnmpstate listsyncjobs getcurrentadmin removeadmin clearfaults setsnmptrapinfo setsnmpinfo getcapacity getsnmpinfo """
