...
@pass_context
def cli(ctx):
    """setsnmptrapinfo setntpinfo getsnmpinfo getinfo setconfig enableencryptionatrest snmpsendtesttraps getsystemstatus setsnmpinfo modifyadmin disablesnmp getcapacity getmasternodeid listsyncjobs getfullthreshold deleteallsupportbundles removeadmin getsnmpstate listadmins enablesnmp getstate getlimits getversioninfo getcurrentadmin getstats listevents listfaults clearfaults setsnmpacl modifyfullthreshold addadmin createsupportbundle disableencryptionatrest getntpinfo getapi create getsnmptrapinfo getsnmpacl getconfig """
