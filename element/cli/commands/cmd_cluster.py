...
@pass_context
def cli(ctx):
    """getapi modifyadmin getsystemstatus getstats createsupportbundle disablesnmp deleteallsupportbundles getsnmpinfo getsnmpacl clearfaults setsnmpinfo getsnmpstate removeadmin setntpinfo getversioninfo snmpsendtesttraps modifyfullthreshold create listsyncjobs getfullthreshold listadmins getlimits setsnmptrapinfo getstate getcapacity getmasternodeid getsnmptrapinfo getcurrentadmin addadmin listfaults getntpinfo setsnmpacl getinfo enablesnmp enableencryptionatrest setconfig getconfig listevents disableencryptionatrest """
