...
@pass_context
def cli(ctx):
    """listadmins getsnmpacl removeadmin clearfaults setsnmpinfo getversioninfo getconfig enablesnmp addadmin getntpinfo getsnmpstate create getlimits getfullthreshold getsnmptrapinfo modifyfullthreshold getsnmpinfo setsnmptrapinfo enableencryptionatrest getstate disablesnmp getinfo disableencryptionatrest setntpinfo setconfig getcapacity setsnmpacl getcurrentadmin snmpsendtesttraps modifyadmin getstats listfaults getsystemstatus listsyncjobs getapi deleteallsupportbundles getmasternodeid listevents createsupportbundle """
