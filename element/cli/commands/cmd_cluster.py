...
@pass_context
def cli(ctx):
    """disableencryptionatrest disablesnmp getconfig getsnmptrapinfo enableencryptionatrest getsystemstatus listsyncjobs setconfig setsnmpacl getlimits getsnmpstate listevents getinfo getcurrentadmin addadmin create snmpsendtesttraps getsnmpinfo setntpinfo getntpinfo setsnmpinfo getcapacity listadmins setsnmptrapinfo getstate getmasternodeid deleteallsupportbundles modifyadmin enablesnmp listfaults getfullthreshold createsupportbundle getstats modifyfullthreshold getsnmpacl removeadmin getversioninfo clearfaults getapi """
