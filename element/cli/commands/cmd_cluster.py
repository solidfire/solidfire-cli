...
@pass_context
def cli(ctx):
    """getmasternodeid listadmins getcapacity getversioninfo snmpsendtesttraps getinfo disableencryptionatrest getfullthreshold enablesnmp setntpinfo getsnmpinfo getstate getcurrentadmin listsyncjobs getsnmptrapinfo removeadmin getntpinfo getlimits setconfig getstats addadmin modifyadmin createsupportbundle create modifyfullthreshold getsnmpacl listevents deleteallsupportbundles disablesnmp clearfaults getsnmpstate getsystemstatus setsnmptrapinfo getconfig setsnmpacl setsnmpinfo getapi listfaults enableencryptionatrest """
