...
@pass_context
def cli(ctx):
    """setsnmpacl addadmin create disablesnmp getsnmpinfo getconfig getsnmpstate getstats snmpsendtesttraps clearfaults listsyncjobs removeadmin getntpinfo getinfo getstate getcurrentadmin getlimits getsnmpacl getapi getsystemstatus setntpinfo getversioninfo enablesnmp getfullthreshold modifyfullthreshold createsupportbundle setsnmptrapinfo disableencryptionatrest setconfig getmasternodeid setsnmpinfo deleteallsupportbundles enableencryptionatrest modifyadmin listfaults getsnmptrapinfo listevents getcapacity listadmins """
