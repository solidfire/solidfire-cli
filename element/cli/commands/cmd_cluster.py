...
@pass_context
def cli(ctx):
    """listadmins createsupportbundle getsystemstatus getstats snmpsendtesttraps getmasternodeid getapi setsnmpacl clearfaults removeadmin deleteallsupportbundles setconfig listfaults getsnmptrapinfo disablesnmp enablesnmp create getntpinfo getsnmpstate modifyadmin listevents setsnmptrapinfo getcapacity modifyfullthreshold getstate getfullthreshold getversioninfo disableencryptionatrest getinfo addadmin getcurrentadmin setntpinfo getsnmpinfo setsnmpinfo getsnmpacl getlimits enableencryptionatrest getconfig listsyncjobs """
