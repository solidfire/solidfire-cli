...
@pass_context
def cli(ctx):
    """getcurrentadmin getntpinfo deleteallsupportbundles removeadmin getcapacity listevents modifyfullthreshold getfullthreshold getlimits addadmin getsystemstatus getversioninfo setntpinfo enableencryptionatrest getapi getstats getinfo setconfig disableencryptionatrest getmasternodeid createsupportbundle listfaults listadmins getstate modifyadmin create listsyncjobs getconfig clearfaults """
