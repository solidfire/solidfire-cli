...
@pass_context
def cli(ctx):
    """setsnmpinfo disablesnmp addadmin setconfig getsnmpacl enablesnmp getcapacity createsupportbundle disableencryptionatrest getversioninfo setsnmpacl clearfaults getsystemstatus setsnmptrapinfo create enableencryptionatrest getinfo getntpinfo listsyncjobs modifyfullthreshold listevents getcurrentadmin getsnmptrapinfo getstate deleteallsupportbundles getmasternodeid listfaults getsnmpinfo getstats removeadmin getapi getfullthreshold getlimits modifyadmin listadmins snmpsendtesttraps getsnmpstate setntpinfo getconfig """
