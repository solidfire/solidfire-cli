...
@pass_context
def cli(ctx):
    """getstats getmasternodeid setconfig createsupportbundle getlimits listevents removeadmin getversioninfo disableencryptionatrest getntpinfo modifyadmin listsyncjobs getstate getcapacity getconfig setntpinfo getinfo getapi clearfaults create getcurrentadmin enableencryptionatrest addadmin deleteallsupportbundles getfullthreshold getsystemstatus listadmins listfaults modifyfullthreshold """
