...
@pass_context
def cli(ctx):
    """addadmin setsnmpinfo modifyfullthreshold enableencryptionatrest disableencryptionatrest disablesnmp listfaults getcurrentadmin getntpinfo modifyadmin getcapacity getinfo getapi getsnmpinfo create getconfig removeadmin deleteallsupportbundles enablesnmp createsupportbundle setconfig listadmins getsnmptrapinfo listevents setsnmptrapinfo getsystemstatus getstate getlimits setsnmpacl listsyncjobs clearfaults getversioninfo getstats getsnmpacl getsnmpstate snmpsendtesttraps setntpinfo getmasternodeid getfullthreshold """
