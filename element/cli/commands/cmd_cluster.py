...
@pass_context
def cli(ctx):
    """getlimits create getsnmpinfo getmasternodeid getsnmpstate removeadmin setntpinfo clearfaults getapi addadmin setconfig setsnmpacl getsystemstatus modifyfullthreshold listfaults getconfig getversioninfo disableencryptionatrest enablesnmp listsyncjobs getstats getcurrentadmin getstate createsupportbundle snmpsendtesttraps getcapacity enableencryptionatrest getsnmptrapinfo modifyadmin getinfo deleteallsupportbundles getfullthreshold listadmins setsnmptrapinfo disablesnmp setsnmpinfo listevents getntpinfo getsnmpacl """
