...
@pass_context
def cli(ctx):
    """enableencryptionatrest getsnmpinfo snmpsendtesttraps getntpinfo disableencryptionatrest getversioninfo setconfig setsnmpacl listsyncjobs createsupportbundle setsnmptrapinfo getapi enablesnmp getsnmpstate getsnmpacl disablesnmp getfullthreshold deleteallsupportbundles addadmin getsystemstatus getinfo getconfig getmasternodeid create setntpinfo modifyfullthreshold setsnmpinfo clearfaults modifyadmin removeadmin getcurrentadmin getstate listevents getlimits listfaults getsnmptrapinfo listadmins getstats getcapacity """
