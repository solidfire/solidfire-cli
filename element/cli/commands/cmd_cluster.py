...
@pass_context
def cli(ctx):
    """listevents listsyncjobs listadmins setconfig getsnmpacl getcapacity setsnmpinfo clearfaults getversioninfo getstate listfaults disableencryptionatrest disablesnmp setsnmptrapinfo modifyadmin getsnmptrapinfo getntpinfo getsnmpinfo getcurrentadmin getapi getlimits enableencryptionatrest enablesnmp getsystemstatus getfullthreshold addadmin getinfo removeadmin createsupportbundle create getmasternodeid deleteallsupportbundles modifyfullthreshold getsnmpstate getstats setsnmpacl getconfig setntpinfo snmpsendtesttraps """
