...
@pass_context
def cli(ctx):
    """getstate getsnmpinfo getcapacity addadmin removeadmin getntpinfo create setsnmptrapinfo enablesnmp setsnmpinfo getversioninfo setconfig listevents getconfig getsystemstatus listadmins snmpsendtesttraps listsyncjobs disablesnmp getlimits deleteallsupportbundles getsnmptrapinfo setsnmpacl clearfaults disableencryptionatrest getstats getapi enableencryptionatrest getmasternodeid modifyadmin getsnmpstate getfullthreshold setntpinfo createsupportbundle listfaults modifyfullthreshold getcurrentadmin getinfo getsnmpacl """
...
def setsnmptrapinfo(ctx,
    ...
    if(traprecipients is not None and traprecipients != ()):
        traprecipientsArray = []
        try:
...
def setsnmpinfo(ctx,
    ...
    networksArray = None
    if(networks is not None and networks != ()):
        networksArray = []
        try:
    ...
    usmusersArray = None
    if(usmusers is not None and usmusers != ()):
        usmusersArray = []
        try:
