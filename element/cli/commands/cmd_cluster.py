...
=======
    """getapi setconfig listsyncjobs getstate snmpsendtesttraps enablesnmp listfaults getcurrentadmin getsnmpstate removeadmin getsnmptrapinfo getversioninfo disableencryptionatrest addadmin listadmins getsnmpacl deleteallsupportbundles setntpinfo getsystemstatus modifyadmin setsnmpacl enableencryptionatrest getinfo getlimits createsupportbundle disablesnmp clearfaults listevents setsnmptrapinfo getsnmpinfo getmasternodeid getcapacity create getconfig modifyfullthreshold getstats getfullthreshold getntpinfo setsnmpinfo """
