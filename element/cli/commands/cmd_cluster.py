...
@pass_context
def cli(ctx):
    """removeadmin setconfig getlimits getcapacity getsnmpstate getsnmptrapinfo clearfaults modifyadmin setsnmptrapinfo getntpinfo create enableencryptionatrest listadmins getconfig modifyfullthreshold getapi setsnmpinfo getstats getsystemstatus listsyncjobs deleteallsupportbundles getversioninfo getsnmpacl disablesnmp getfullthreshold createsupportbundle addadmin getcurrentadmin listfaults getinfo getsnmpinfo getmasternodeid enablesnmp setsnmpacl disableencryptionatrest listevents setntpinfo snmpsendtesttraps getstate """
